  ...
  return (
    ...
    <div className="bg-white p-6 rounded-md shadow-lg max-w-md w-full relative">
      ...
      <form className="space-y-4">
        ...
        <div>
          <label htmlFor="donation" className="block text-sm font-medium text-gray-700">Donation</label>
          <input
            type="text"
            id="donation"
        ...
        <button type="submit" className="w-full bg-blue-500 text-white p-2 rounded-md btn">
          Update
        </button>
      </form>
    </div>
